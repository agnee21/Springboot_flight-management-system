...
public class IScheduleServiceImpl implements IScheduleService {
	...
	// method to get list of all schedules
	@Override
	...
	// method to get a list of schedules based on source and destination
	@Override
	...
	// method to get a list of schedules based on source,destination and departure date
	@Override
	...
	// method to get list of schedules based on departure date
	@Override
