...
public class IPassengerServiceImpl implements IPassengerService {
	...
	public List<PassengerDTO> viewAllPassenger() {
		...
		List<PassengerDTO> passengerlist = passengerRepository.findAll().stream().map(e -> toPassengerDto(e))
				.collect(Collectors.toList());

		return passengerlist;
	}

	// method to get a passenger based on UIN number
	@Override
	...
	// method to get a passenger based on mobile number
	@Override
