...
public class IFlightServiceImpl implements IFlightService {
	...
	// method to get a flight by flight ID
	@Override
	...
	// method to get list of flight order by flight name
	@Override
	...
	// method to get list of flight order by seat capacity
	@Override
	...
	// method to get list of flight based on source and destination
	@Override
	...
	// method to get list of flight based on date
	@Override
	...
	// method to get list of flight based on source,destination and departure date
	@Override
